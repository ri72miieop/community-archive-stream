...
export interface LikesResponse {
  ...
  export const LikedTweetsInterceptor: Interceptor =  (req, res) => {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent('dataInterceptedEvent', { detail: {data:res.responseText, type: "api_liked_tweets", timestamp: new Date().toISOString()}}));
