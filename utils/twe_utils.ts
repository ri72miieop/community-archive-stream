import type { ItemContentUnion, Media, TimelineAddEntriesInstruction, TimelineEntry, TimelineInstructions, TimelineTimelineItem, TimelineTimelineModule, TimelineTweet, TimelineTwitterList, TimelineUser, Tweet, TweetUnion, User } from "~InterceptorModules/types";
